Legal Liability from Ruter:
This data set is meant for educational purposes for the class of DAVE3625 in OsloMet only.
Any commercial use or redistribution of this data for research purposes is not allowed.
The data can only be used for the assignments and projects of the mentioned class.
